...
# python3.9 -m pip install torch==2.0.1+cu118 torchvision==0.15.2+cu118 torchaudio==2.0.2+cu118 --index-url https://download.pytorch.org/whl/cu118
	...
	python3.9 -m pip install numpy==1.22.0 tqdm wandb opencv-python-headless pandas matplotlib==3.6.2 timm==0.6.12 scipy==1.9.3 onnx==1.15.0 onnxruntime-gpu==1.15.0
